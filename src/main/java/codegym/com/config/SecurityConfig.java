...
import codegym.com.config.jwt.JwtAuthenticationTokenFilter;
        ...
        return http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(
                        auth -> auth
                                ...
                                .requestMatchers("/api/login", "/api/properties", "/api/property-types", "/api/room-types","/**","/api/bookings","/auth/v1/SSO/google","/auth/**", "/auth/google/callback", "/api/users/register","/oauth2/**").permitAll()
